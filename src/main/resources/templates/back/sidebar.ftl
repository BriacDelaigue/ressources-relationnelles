        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="pages/email-compose.html"><i class="fas fa-fw fa-chart-pie"></i>
                            Statistique</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="pages/email-compose.html"><i class="fas fa-fw fa-edit"></i>
                            Créer des comptes</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/email-compose.html"><i class="fas fa-fw fa-plus-square"></i>
                            Créer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/email-compose.html"><i
                                    class="fas fa-fw fa-exclamation-triangle"></i>
                            Administrer</a>
                    </li>
